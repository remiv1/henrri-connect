...
class DecorativeDocumentLine(DocumentLine):  # pylint: disable=C0115
    id: int | None = ...
    document_id: int | None = ...
    reference: str | None = ...
    description: str | None = ...
    ...
    def horizontal_line(self) -> "DocumentLine":... # pylint: disable=C0116
    def empty_line(self) -> "DocumentLine":...# pylint: disable=C0116
    def subtotal_line(self) -> "DocumentLine":...# pylint: disable=C0116
    def total_line(self) -> "DocumentLine":...# pylint: disable=C0116
    def textual_line(self, text: str) -> "DocumentLine":...# pylint: disable=C0116, W0613
