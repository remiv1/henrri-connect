...
Constants:
- ``henrri_connect.connect._BASE_URL`` : URL de base de l'API Henrri.
- ``henrri_connect.connect.APP_VERSION`` : Version de l'application.

Classes:
- ``henrri_connect.connect.AsyncHenrriClient`` : Client HTTP Henrri asynchrone.
- ``henrri_connect.connect.SyncHenrriClient`` : Client HTTP Henrri synchrone.
