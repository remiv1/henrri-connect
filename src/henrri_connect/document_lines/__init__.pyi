...
class SyncDocumentLinesClient: # pylint: disable=C0115
    ...
    def list_document_lines(self, document_id: int) -> ListResponse[DocumentLine]: ... # pylint: disable=C0116, W0613
...
class AsyncDocumentLinesClient: # pylint: disable=C0115
    def __init__(self, client: Any) -> None: ... # pylint: disable=W0613
    async def list_document_lines(self, document_id: int) -> ListResponse[DocumentLine]: ... # pylint: disable=C0116, W0613
