...
Classes:
- ``henrri_connect.items.asynchro.AsyncItemsClient`` : Accès asynchrone aux endpoints articles.
- ``henrri_connect.items.synchro.SyncItemsClient`` : Accès synchrone aux endpoints articles.
